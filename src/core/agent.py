...
class BaseAgent:
    ...
    def __init__(self, model, modelParams, Nin, Nout, initial_data, protocol, protocolParams, mix, mixingParams):
    ...
    def update(self, **kwargs):
        ...
        local_grad = self._model.compute_gradient(self._data, **kwargs)
